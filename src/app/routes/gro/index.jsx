            ...
            <div id="et-boc" className="et-boc">
               <div className="et-l et-l--post">
                  <div className="et_builder_inner_content et_pb_gutters3">
                     <div
                        className="et_pb_section et_pb_section_0 et_pb_section_parallax et_pb_with_background et_pb_fullwidth_section et_section_regular">
                        <div className="et_parallax_bg_wrap">
                           <div className="et_parallax_bg"
                              style={{
                                 backgroundImage: 'url(http://seph.net/growthdefi/wp-content/uploads/2021/05/crypto_illustration_11.png)'
                              }}>
                           </div>
                        </div>
                        <section
                           className="et_pb_module et_pb_fullwidth_header et_pb_fullwidth_header_0 et_animated et_hover_enabled et_pb_text_align_center et_pb_bg_layout_dark">
                              ...
                              <div className="header-content-container center">
                                 <div className="header-content">
                                    <img loading="lazy" width={256} height={256}
                                       src="http://seph.net/growthdefi/wp-content/uploads/2021/05/gro-logo.png" title alt
                                       srcSet="http://seph.net/growthdefi/wp-content/uploads/2021/05/gro-logo.png 256w, http://seph.net/growthdefi/wp-content/uploads/2021/05/gro-logo-150x150.png 150w"
                                       sizes="(max-width: 256px) 100vw, 256px" className="header-logo wp-image-27" />
                                    <h1 className="et_pb_module_header">GRO Token</h1>
                                    <div className="et_pb_header_content_wrapper">
                                       <p className="blockParagraph-544a408c" data-key="fcf003555ca04ed1bd021212cf4c10ba">
                                          <span className="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1"><span
                                             data-key="667f836fd7104675a2ba6164810fcb4b">GRO is the core token
                                       ...
                                       <p className="blockParagraph-544a408c" data-key="a5a91432762842cfb2474b4d2bf0fd3d"
                                          ...
                                          <span className="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1"><span
                                             data-key="c1f50bcf0d7a418db585a2b9529f553f">GRO can be staked for
                     ...
                     <div className="et_pb_section et_pb_section_1 et_pb_with_background et_section_regular">
                           ...
                           <div
                              ...
                              <div className="et_pb_module et_pb_image et_pb_image_0 et_animated et-waypoint">
                                 <span className="et_pb_image_wrap "><img loading="lazy"
                                    src="http://seph.net/growthdefi/wp-content/uploads/2021/05/Crypto_Illustration_03-1.png"
                                    alt title height="auto" width="auto"
                                    srcSet="http://seph.net/growthdefi/wp-content/uploads/2021/05/Crypto_Illustration_03-1.png 800w, http://seph.net/growthdefi/wp-content/uploads/2021/05/Crypto_Illustration_03-1-480x480.png 480w"
                                    sizes="(min-width: 0px) and (max-width: 480px) 480px, (min-width: 481px) 800px, 100vw"
                                    className="wp-image-56" /></span>
                              </div>
                           </div> {/* .et_pb_column */}
                           <div
                              ...
                              <div
                                 ...
                                 <div className="et_pb_text_inner">
                                    <p className="blockParagraph-544a408c" data-key="7d9fe753bd0f4fecbe32ddec3ad4bdfc"><span
                                       className="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1"><span
                                          data-key="b8cfb5ea166742c68168a2f168870e14">Circulating supply of
                                       342,286 GRO </span></span></p>
                                    <p className="blockParagraph-544a408c" data-key="d0c2d91adb7a4f5c8e5f6f6f95ad909d"
                                       ...
                                       <span className="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1"><span
                                          data-key="100ef60fbf55496497d3415b8e363018">Total supply of 580,977
                                       GRO</span></span>
                                    </p>
                                    <p className="blockParagraph-544a408c" data-key="d0c2d91adb7a4f5c8e5f6f6f95ad909d"
                                       data-slate-fragment="">
                                       <span className="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1"><span
                                          data-key="100ef60fbf55496497d3415b8e363018">Marketcap:
                        ...
                        <div className="et_pb_row et_pb_row_1">
                           <div
                              className="et_pb_column et_pb_column_1_2 et_pb_column_2  et_pb_css_mix_blend_mode_passthrough">
                              <div
                                 className="et_pb_module et_pb_text et_pb_text_2  et_pb_text_align_right et_pb_bg_layout_dark">
                                 <div className="et_pb_text_inner">
                                    <h2>Deflationary&nbsp;</h2>
                                 </div>
                              </div> {/* .et_pb_text */}
                              ...
                              <div
                                 className="et_pb_module et_pb_text et_pb_text_3  et_pb_text_align_right et_pb_bg_layout_dark">
                                 <div className="et_pb_text_inner">
                                    <p className="blockParagraph-544a408c" data-key="2745111dde9f4987ae2fc1320f19c8bb"><span
                                       className="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1"><span
                                          data-key="1c3bce2113d54d6ab3c62502c3435ce4">GRO Bridge (1.5% of every
                                       swap is burnt)</span></span></p>
                                    <p className="blockParagraph-544a408c" data-key="3e12f9828ac242509314c9942e042568"><span
                                       className="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1"><span
                                          data-key="6ccb855c07dc4561a5bb2ae7be8c4312">stkGRO (5% of every
                                       stake/unstake is burnt)</span></span></p>
                                    <p className="blockParagraph-544a408c" data-key="c356d40cc0374d1f92fe04f359a9ee43"><span
                                       className="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1"><span
                                          data-key="b520691ca52947a59c759bc036a53670">GRO Yield (3% of every
                                       deposit/withdrawal is burnt)</span></span></p>
                                    <p className="blockParagraph-544a408c" data-key="954c5ac7e79149e09e557af93616a1c0"
                                       ...
                                       <span className="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1"><span
                                          data-key="739e8fb4eb32420ea80344815abd003d">WHEAT Buyback Contract
                           ...
                           <div
                              className="et_pb_column et_pb_column_1_2 et_pb_column_3  et_pb_css_mix_blend_mode_passthrough et-last-child">
                              <div className="et_pb_module et_pb_image et_pb_image_1 et_animated et-waypoint">
                                 <span className="et_pb_image_wrap "><img loading="lazy"
                                    src="http://seph.net/growthdefi/wp-content/uploads/2021/05/Crypto_Illustration_05-1.png"
                                    alt title height="auto" width="auto"
                                    srcSet="http://seph.net/growthdefi/wp-content/uploads/2021/05/Crypto_Illustration_05-1.png 800w, http://seph.net/growthdefi/wp-content/uploads/2021/05/Crypto_Illustration_05-1-480x480.png 480w"
                                    sizes="(min-width: 0px) and (max-width: 480px) 480px, (min-width: 481px) 800px, 100vw"
                                    className="wp-image-57" /></span>
                              </div>
                           </div> {/* .et_pb_column */}
                        </div> {/* .et_pb_row */}
                     </div> {/* .et_pb_section */}
                     <div
                        className="et_pb_section et_pb_section_2 et_pb_section_parallax et_pb_with_background et_section_regular">
                        <div className="et_parallax_bg_wrap">
                           <div className="et_parallax_bg"
                              style={{
                                 backgroundImage: 'url(http://seph.net/growthdefi/wp-content/uploads/2021/05/crypto-bg-02b.png)'
                              }}>
                           </div>
                        </div>
                              ...
                              <div className="et_pb_module et_pb_tabs et_pb_tabs_0 ">
                                 ...
                                 <div className="et_pb_all_tabs">
                                    <div className="et_pb_tab et_pb_tab_0 clearfix et_pb_active_content">
                                       <div className="et_pb_tab_content">
                                          <div style={{ width: '50%', float: 'left' }}>
                                             <img
                                                src="http://seph.net/growthdefi/wp-content/uploads/2021/05/uniswap-uni-logo.png"
                                                style={{
                                                   width: 300, display: 'block', marginLeft: 'auto',
                                                   marginRight: 'auto'
                                                }} />
                                             <p />
                                          ...
                                          <div style={{ width: '50%', display: 'inline' }}>
                                             <img
                                                src="http://seph.net/growthdefi/wp-content/uploads/2021/05/pancakeswap-cake-logo.png"
                                                style={{
                                                   width: 300, display: 'block', marginLeft: 'auto',
                                                   marginRight: 'auto'
                                                }} />
                                    ...
                                    <div className="et_pb_tab et_pb_tab_1 clearfix">
                                       <div className="et_pb_tab_content"><img
                                          src="http://seph.net/growthdefi/wp-content/uploads/2021/05/stkgro.png"
                                          style={{ display: 'block', marginLeft: 'auto', marginRight: 'auto' }} /></div>
                                    </div> {/* .et_pb_tab */}
                                    <div className="et_pb_tab et_pb_tab_2 clearfix">
                                       <div className="et_pb_tab_content"><img
                                          src="http://seph.net/growthdefi/wp-content/uploads/2021/05/groyield.png"
                                          style={{ display: 'block', marginLeft: 'auto', marginRight: 'auto' }} /></div>
                                    </div> {/* .et_pb_tab */}
                                    <div className="et_pb_tab et_pb_tab_3 clearfix">
                                       <div className="et_pb_tab_content"><img
                                          src="http://seph.net/growthdefi/wp-content/uploads/2021/05/grobridge.png"
                                          style={{ display: 'block', marginLeft: 'auto', marginRight: 'auto' }} /></div>
                                    </div> {/* .et_pb_tab */}
                                 </div> {/* .et_pb_all_tabs */}
                              </div> {/* .et_pb_tabs */}
                     ...
                     <div
                        className="et_pb_section et_pb_section_3 et_pb_section_parallax et_pb_with_background et_section_regular section_has_divider et_pb_top_divider">
                        <div className="et_pb_top_inside_divider et-no-transition" />
                        <div className="et_parallax_bg_wrap">
                           <div className="et_parallax_bg"
                              style={{
                                 backgroundImage: 'url(http://seph.net/growthdefi/wp-content/uploads/2021/05/crypto-bg-02.png)'
                              }}>
                           </div>
                        </div>
                        <div className="et_pb_row et_pb_row_3">
                           <div
                              ...
                              <div
                                 className="et_pb_module et_pb_text et_pb_text_4  et_pb_text_align_center et_pb_bg_layout_dark">
                                 <div className="et_pb_text_inner">
                              ...
                              <div
                                 className="et_pb_module et_pb_text et_pb_text_5  et_pb_text_align_center et_pb_bg_layout_dark">
                                 <div className="et_pb_text_inner">
                        ...
                        <div className="et_pb_row et_pb_row_4">
                           <div
                              ...
                              <div
                                 className="et_pb_module et_pb_blurb et_pb_blurb_0  et_pb_text_align_left  et_pb_blurb_position_top et_pb_bg_layout_light">
                                 <div className="et_pb_blurb_content">
                                    <div className="et_pb_main_blurb_image"><span className="et_pb_image_wrap"><img
                                       loading="lazy" width={256} height={256}
                                       src="http://seph.net/growthdefi/wp-content/uploads/2021/05/groot-logo.png" alt
                                       srcSet="http://seph.net/growthdefi/wp-content/uploads/2021/05/groot-logo.png 256w, http://seph.net/growthdefi/wp-content/uploads/2021/05/groot-logo-150x150.png 150w"
                                       sizes="(max-width: 256px) 100vw, 256px"
                                       className="et-waypoint et_pb_animation_top wp-image-28" /></span></div>
                           ...
                           <div
                              ...
                              <div
                                 className="et_pb_module et_pb_blurb et_pb_blurb_1  et_pb_text_align_left  et_pb_blurb_position_top et_pb_bg_layout_light">
                                 <div className="et_pb_blurb_content">
                                    <div className="et_pb_main_blurb_image"><span className="et_pb_image_wrap"><img
                                       loading="lazy" width={100} height={184}
                                       src="http://seph.net/growthdefi/wp-content/uploads/2021/05/wheat-logo.png" alt
                                       className="et-waypoint et_pb_animation_top wp-image-29" /></span>
                                    </div>
                                    <div className="et_pb_blurb_container">
